...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                    ...
                    .antMatchers("/api/studyclass/*").permitAll()
                    .antMatchers("/api/studyclass/detail/*").permitAll()
                    .antMatchers("/api/studyclass/*/notice").permitAll()
                    .antMatchers("/api/studyclass/*/board").permitAll()
